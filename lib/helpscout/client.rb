...
module HelpScout
  class Client
    ...
    # List Conversations assigned to a user
    # http://developer.helpscout.net/conversations/
    #
    # Return conversations in a specific folder of a mailbox.
    #
    ...
    def conversations_assigned_to_user(mailboxId, userId, status, limit=0, modifiedSince)
      url = "/mailboxes/#{mailboxId}/users/#{userId}/conversations.json"
